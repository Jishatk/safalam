...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <body>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<div class="nav_right_top">
						<ul class="nav navbar-nav">
							...
							<li>
								<a class="scroll" href="#Register">Register</a>
							</li>
							<li class="dropdown" >
        ...
        <%
            String nam="",dob="",adr="",st="",ct="",mail="",pwd="";
            int mb=0;
	...
	<div class="banner_bottom donate-log">
        ...
        <table border="0" >
            ...
            <td>
                <input type="date" name="dob" min="1947-10-20" max="2001-01-01" /></td>
                </tr>
                    <tr>
            <td><label >Gender</label></td>
            <td><input type="radio" name="gender" value="m" />Male<input type="radio" name="gender" value="f" />Female<input type="radio" name="gender" value="o" />others</td>
                </tr>
